...
public class ImgProcess7 {
    ...
    public static void main(String[] args) {
        ...
        Long intHorizontalLinePosition = Math.round((double)imgFrame1.rows() * 0.65);

        Point p1 = new Point(0,intHorizontalLinePosition);
        Point p2 = new Point(imgFrame1.cols() - 1,intHorizontalLinePosition);
        ...
        while(cap.isOpened()){
            ...
            boolean blnAtLeastOneBlobCrossedTheLine = checkIfBlobsCrossedTheLine(blobs, intHorizontalLinePosition.intValue());
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    static boolean checkIfBlobsCrossedTheLine(List<Blob> blobs, int intHorizontalLinePosition) {
